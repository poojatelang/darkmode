...
export default function Navbar() {
  ...
  return (
    ...
    } p-4 flex justify-between items-center shadow-md transition-all duration-300`}
  >
    {/* <nav className="bg-white dark:bg-gray-800 p-4 flex justify-between items-center shadow-md transition-all duration-300"> */}
      {/* <div className={`p-5 rounded-xl shadow-lg w-96 transition-colors 
         ${resolvedTheme === "dark" ? "bg-black text-white" : "bg-gray-50 text-black"}`}></div> */}
      {/* <h1 className="text-xl font-bold text-gray-900 dark:text-white">Next.js App</h1> */}
...
<a href="/" className="hover:underline">Home</a>
        ...
        <a href="/card" className="hover:underline">Card</a>
        ...
        {/* {mounted && (
          <button
            ...
            className="px-3 py-1 bg-gray-700 dark:bg-gray-300 text-black dark:text-white rounded border border-gray-500 dark:border-gray-400 transition-all duration-300"
          >
